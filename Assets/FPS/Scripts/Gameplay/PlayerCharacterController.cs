...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        private static Action RefreshRect { get; set; }
        ...
        {
            PlayerCamera.transform.Find("WeaponCamera").GetComponent<Camera>().rect = PlayerCamera.rect;
            PlayerCamera.transform.Find("UICamera").GetComponent<Camera>().rect = PlayerCamera.rect;
        }
